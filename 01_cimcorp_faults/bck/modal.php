				...
				<div  class="col-md-6 col-sm-12 col-xs-12 form-group">
				 ...
				 <div  class="col-md-6 col-sm-12 col-xs-12 form-group">
				   ...
				   <div class="col-md-3 col-sm-12 col-xs-12 form-group">
					...
					<?php
						include ('login/conf.php');
							$query = "SELECT * FROM `mp_34matrix` WHERE `mp_1` =  '".$_SESSION["location"]."'  AND NOT `mp_6` IN ('','0') ORDER BY `mp_2` ASC";
							$result = mysql_query($query) or die(mysql_error());
							while($row = mysql_fetch_array($result)){
							echo '<option value = "'.$row['mp_4'].'">'.$row['mp_3'].''.$row['mp_4'].'</option>';	
								}
						mysql_close($conn);	
					 ?>	
				 </select>
...
<div id="view_data_modal" class="modal fade">  
      <div class="modal-dialog modal-lg">  
           <div class="modal-content">  
                <div class="modal-header">  
                     <button type="button" class="close" data-dismiss="modal">&times;</button>  
                     <h4 class="modal-title">Schichtreport - Details</h4>  
                </div> 

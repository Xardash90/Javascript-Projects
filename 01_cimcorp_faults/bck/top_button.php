...
echo'			<div class="form-group  btn-group">				
					...
					<button class="btn btn-default btn-xs InboundDetails" id="toggle_btn" type="button" data-toggle="collapse" data-target="#InboundDetails" aria-expanded="false" aria-controls="InboundDetails"> Bearbeitungsstatus-Übersicht <i id="btnP"></i> </button>
				</div>
		';		
?>	
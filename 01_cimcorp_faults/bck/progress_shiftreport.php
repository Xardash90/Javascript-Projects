	...
	ECHO '<div class="row container d-flex justify-content-center">
                <div class="panel panel-default ">
                    <div class="panel-heading">
                        <h4 class="panel-title" title=""> <i style="color: #000;" class="fa fa-cog"></i> Einträge im Status "In Bearbeitung"</h4>
					</div>
				
				';
		//Funktionen für TOP Button --> Datum, Mitarbeiter auswählen und Alle anzeigen

		$query = "SELECT * FROM `mp_38matrix` WHERE `mp_5` = 'In Bearbeitung' AND `mp_1` = '".$_SESSION["location"]."' AND `mp_9` = 'CC_SCHIFTREPORT' AND DATE(`mp_2`) = CURDATE()  ORDER BY `mp_2` DESC"; 

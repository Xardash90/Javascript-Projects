...
$end_date_result = date( 'Y-m-d H:i:s', $end_date_manuell );		  
	...
	mysql_query(" UPDATE  `wi_home`.`mp_38matrix` SET 	
				...
				");
		// Logfile		
		mysql_query("INSERT INTO `wi_home`.`mp_33matrix`(`mp_1`, `mp_2`, `mp_3`, `mp_4`, `mp_5`, `mp_6`)  
					VALUES 
			   ('".trim($_SESSION["location"])."', 'SR-".trim($_POST["id"])."', '".$_SESSION["fname"]." ".$_SESSION["lname"]."', '".$_SESSION["id"]."', '".$_POST["mp_5"]."', 'Manuelle änderung vorgenommen !' ) ");		
	  };

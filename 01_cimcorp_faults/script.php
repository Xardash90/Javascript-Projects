...
$(document).ready(function() {
   ...
   $('#from_date').daterangepicker({
	...
	$(".segment_list").click(function(){ 
		...
		$(".statistic_list").click(function(){ 
		NProgress.start();
		$('#live_data').load('lists/01_cimcorp_faults/fetch_statistic.php');
		NProgress.done();
	});
	
	$(".pdf_archiv").click(function(){ 
		NProgress.start();
		$('#live_data').load('lists/01_cimcorp_faults/fetch_archiv.php');
		NProgress.done();
	});
 ...
 $(document).on('click', '.view_data', function(){ 
           ...
           {  
                $.ajax({  
                     url:"lists/01_cimcorp_faults/fetch_modal.php",  
                     method:"POST",  
                     data:{id:id},  
                     success:function(data){  
...
$(document).on('click','.InboundDetails',function (){
	...
	$('#shiftreport_done').load('lists/01_cimcorp_faults/done_shiftreport.php');
	$('#shiftreport_done').load('lists/01_cimcorp_faults/done_shiftreport.php');
	$('#statistic_overview').load('lists/01_cimcorp_faults/fetch_statistic.php');
	});
$(document).ready(function(){
$("#btnP").html('<i class="fa fa-angle-up"></i>');
$("#btnBPL").html('<i class="fa fa-angle-down"></i>');
